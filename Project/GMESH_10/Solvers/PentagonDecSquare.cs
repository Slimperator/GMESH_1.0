...
namespace Solvers
{
    ...
    public class PentagonDecSquare : IContourDecompositor, IVisitor
    {
        ...
        public IContour[] decomposed(IContour contour)
        {
            ...
            finalDecompose.Add(new Contour(new List<ICurve> { new Line(generalPoints[0], pointsOfCurvs[2]), contour[2], new Line(pointsOfCurvs[3], generalPoints[4]), new Line(generalPoints[4], generalPoints[0]) }));
