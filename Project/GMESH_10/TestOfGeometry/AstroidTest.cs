...
namespace TestOfGeometry
{
    ...
    /// <summary>
    ///Это класс теста для AstroidTest, в котором должны
    ///находиться все модульные тесты AstroidTest
    ///</summary>
    [TestClass()]
    public class AstroidTest
    {
        ...
        /// <summary>
        ///Тест для Конструктор Astroid
        ///</summary>
        [TestMethod()]
        public void AstroidConstructorTest()
        {
            ...
            Astroid target = new Astroid(center, radius);
        ...
        public void getPointTest()
        {
            IPoint center = new Point(0, 0); // TODO: инициализация подходящего значения
            double radius = 0F; // TODO: инициализация подходящего значения
            Astroid target = new Astroid(center, radius); // TODO: инициализация подходящего значения
