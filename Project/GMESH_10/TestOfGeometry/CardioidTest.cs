...
namespace TestOfGeometry
{
    ...
    /// <summary>
    ///Это класс теста для CardioidTest, в котором должны
    ///находиться все модульные тесты CardioidTest
    ///</summary>
    [TestClass()]
    public class CardioidTest
    {
        ...
        /// <summary>
        ///Тест для Конструктор Cardioid
        ///</summary>
        [TestMethod()]
        public void CardioidConstructorTest()
        {
            ...
            Cardioid target = new Cardioid(center, radius);
